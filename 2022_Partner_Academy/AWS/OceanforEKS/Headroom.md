...
5. 가상노드그룹에 헤드룸을 설정합니다.
  1. Cluster(Hands-on-eks) > Vitual Node Group > VNG Name (eks-Handson-vng)를 클릭하여 VNG를 편집합니다.
  2. 스크롤을 내려 Headroom 항목을 찾고 값을 입력합니다.
    - Reserve: 1
    - CPU : 1500
    - Memory : 1000
    - GPUs : 0
...
6. Ngrinder Agent app을 스케일 아웃하고 Ocean 콘솔에서 컴퓨팅 리소스를 확인합니다.
    ```bash
...
- 다음주제: [Revert to Lower Cost Node](./ReverttoLowerCostNdoe.md)
