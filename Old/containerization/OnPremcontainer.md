...
**사전 준비사항** 
 - [ ] [K8s Cluster 접속 환경 셋업](https://github.com/netappkr/NetAppCloudSolutionCenter/blob/master/K8s_on_MultiCloud/OnPremNKS.) 
 - [ ] [Trident 설치 및 Backend 구성](https://github.com/netappkr/NetAppCloudSolutionCenter/blob/master/K8s_on_MultiCloud/OnPremNKS.md) 
 - [ ] [VM 기반의 Ghost 블로그 App 설치](https://github.com/netappkr/NetAppCloudSolutionCenter/blob/master/Pre-Work2/README.md)
...
3. Content 볼륨에 대해 Clone을 수행합니다.
   ...
   ![enter image description here](https://github.com/netappkr/NetAppCloudSolutionCenter/blob/master/containerization/images/content_clone_2.png)
...
3.  Trident에서 제공하는 Import 기능을 통해  Step1에서 생성한 content clone 볼륨을 해당 Cluster내의 PVC 볼륨으로 Import 합니다. ([import-pvc.yaml](https://github.com/netappkr/NetAppCloudSolutionCenter/blob/master/containerization/files/import-pvc.yaml))
...
> [Trident의 Legacy Volume Import Task](https://github.com/netappkr/NetAppCloudSolutionCenter/blob/master/K8s_with_Trident/README.md)

 ## Step 3. Ghost 블로그 Container 실행   
1. Ghost deployment yaml 파일로 신규 Ghost 블로그 POD를 생성합니다. ([ghost_deployment.yaml](https://github.com/netappkr/NetAppCloudSolutionCenter/blob/master/containerization/files/ghost_deployment.yaml))
...
![enter image description here](https://github.com/netappkr/NetAppCloudSolutionCenter/blob/master/containerization/images/ghost_import.PNG)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTYzOTAxNzQ1NywtMTk0OTQ1NDY4LDE5MD
g0ODY4MTcsMzc4OTYyMzYyLDkyOTE5MDU1NywxNDQ2NTQyMzYw
LDM5NDQ5NjQ5MCwtNzY2MTM4OTA5LC04OTIyOTUxODksMjA1OD
